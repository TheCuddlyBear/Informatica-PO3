...
<title>Dashboard - DeDemiFanShop</title>
                        ...
                        <div class="card shadow border-left-primary py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-primary font-weight-bold text-xs mb-1"><span>Earnings (this month)</span></div>
                                        <div class="text-dark font-weight-bold h5 mb-0"><span>&#8364;<?php echo $earnings; ?></span></div>
                                    </div>
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-success py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-success font-weight-bold text-xs mb-1"><span>Earnings (this year)</span></div>
                                        <div class="text-dark font-weight-bold h5 mb-0"><span>&#8364;<?php echo $yearEarnings; ?></span></div>
                                    </div>
                    ...
                    <div class="col-md-6 col-xl-3 mb-4">
                        <div class="card shadow border-left-info py-2">
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        <div class="text-uppercase text-info font-weight-bold text-xs mb-1"><span>Completed Orders</span></div>
                                        <div class="row no-gutters align-items-center">
                                            <div class="col-auto">
                                                <div class="text-dark font-weight-bold h5 mb-0 mr-3"><span><?php echo $percentage . "%"; ?></span></div>
                                            </div>
                                            <div class="col">
                                                <div class="progress progress-sm">
                                                    <div class="progress-bar bg-info" aria-valuenow=<?php echo '"' . $percentage . '"'; ?> aria-valuemin="0" aria-valuemax="100" style=<?php echo '"width: ' . $percentage . '%;"'; ?> ><span class="sr-only"><?php echo $percentage . "%"; ?></span></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center no-gutters">
                                    <div class="col mr-2">
                                        ...
                                        <div class="text-dark font-weight-bold h5 mb-0"><span><?php echo $pendingOrders; ?></span></div>
                                    </div>
                    ...
                    <div class="col-lg-5 col-xl-4">
                        <div class="card shadow mb-4">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h6 class="text-primary font-weight-bold m-0">Bestellingen</h6>
                            ...
                            <div class="card-body">
                                <div class="chart-area"><canvas data-bs-chart=<?php echo '"{&quot;type&quot;:&quot;pie&quot;,&quot;data&quot;:{&quot;labels&quot;:[&quot;Pending&quot;,&quot;Sent&quot;,&quot;OTW&quot;,&quot;Delivered&quot;],&quot;datasets&quot;:[{&quot;label&quot;:&quot;&quot;,&quot;backgroundColor&quot;:[&quot;#4e73df&quot;,&quot;#1cc88a&quot;,&quot;#36b9cc&quot;,&quot;#63c69c&quot;],&quot;borderColor&quot;:[&quot;#ffffff&quot;,&quot;#ffffff&quot;,&quot;#ffffff&quot;,&quot;#ffffff&quot;],&quot;data&quot;:[&quot;' . $pendingOrders .  '&quot;,&quot;' . $sentOrders .  '&quot;,&quot;' . $otwOrders . '&quot;,&quot;' . $completedOrders . '&quot;]}]},&quot;options&quot;:{&quot;maintainAspectRatio&quot;:false,&quot;legend&quot;:{&quot;display&quot;:true,&quot;reverse&quot;:false},&quot;title&quot;:{}}}"'; ?>></canvas></div>
                            </div>
                        </div>
                </div>
            </div>
