      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav">
         ...
         <li class="nav-item dropdown">
          ...
          <li class="nav-item">
           <a class="nav-link active" href="contact.php"><svg class="bi bi-at" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<form action="mail.php" method="POST" style="padding: 10px">
Naam <br><input type="text" name="name"><br>
Email<br><input type="&#7831;ext" name="email"><br>
Bericht<br><textarea name="message" rows="6" cols="25"></textarea><br \>
